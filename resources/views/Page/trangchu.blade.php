                            ...
                            <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                                ...
                                <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                    ...
                                    <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                        ...
                                        src="source/image/slide/{{ $slider->image }}"
                                        data-src="source/image/slide/{{ $slider->image }}"
                                        style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url(source/image/slide/{{ $slider->image }}); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                    </div>
                                </div>
                            </li>
                        @endforeach
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="beta-products-list">
                            <h4>Top Products</h4>
                            <div class="beta-products-details">
                                <p class="pull-left">Tim thay {{ count($sanpham_khuyenmai) }} </p>
                                <div class="clearfix"></div>
                            </div>
                            <div class="row">
